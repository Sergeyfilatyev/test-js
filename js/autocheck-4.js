...
//   const resultArray = users.filter(user => user.eyeColor === color);
//   return resultArray;
// };
...
//   },
// ];
// console.log(getUsersWithEyeColor(a, 'blue'));
// console.log(getUsersWithEyeColor(a, 'green'));
// console.log(getUsersWithEyeColor(a, 'brown'));
...
//   },
// ];
// console.log(getUsersWithAge(b, 20, 30));
// console.log(getUsersWithAge(b, 30, 40));
// console.log(getUsersWithAge(b, 80, 100));
...
// const eachElementInFirstIsEven = firstArray.every(elememt => elememt % 2 === 0);
// const eachElementInFirstIsOdd = firstArray.every(elememt => elememt % 2 !== 0);
...
// const eachElementInThirdIsEven = thirdArray.every(elememt => elememt % 2 === 0);
// const eachElementInThirdIsOdd = thirdArray.every(elememt => elememt % 2 !== 0);
...
//   const totalFriend = users.reduce((acc, user) => {
...
//   const descendingFriends = [...users].sort(
...
//   const names = [...users].sort((firstUser, secondUser) =>
...
//   const sortedByfriend = [...users]
//     .sort((a, b) => a.friends.length - b.friends.length)
//     .map(user => user.name);
//   return sortedByfriend;
// };
// console.table(
...
//     .filter((elem, index, arrray) => arrray.indexOf(elem) === index)
//     .sort((a, b) => a.localeCompare(b));
//   return sortFriends;
// };
// console.log(
